...
Course.create([
    {
      name: "Discover git",
      description: "Discover the basics of Git, including how to initialize a "\
        "repo. Learn how to add, commit, and push your code to GitHub.",
      is_active: true,
...
Subject.create([
    ...
    },
    {
      ...
      instruction:  "Learn more Rails with this sequel to the infamous Rails "\
        "for Zombies course. Increase your Ruby on Rails knowledge with even "\
        "more zombie learning."
    },
    {
    ...
    },
    {
      ...
      instruction: "Learn Rails testing for your applications with these testing "\
        "fundamentals. Brush up on testing best practices with Rails Testing "\
        "for Zombies."
    },
    {
      name: "Testing with RSpec",
      instruction: "Learn to use this trusted testing framework for Ruby "\
        "applications. Brush up on testing best practices with our Testing "\
        "with RSpec course."
    }
  ])
